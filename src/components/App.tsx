...
import dummyImage from '../images/iphone-mockup.png';
                ...
                <div className="body-wrap boxed-container">
                        ...
                        <div className="container">
                            <div className="site-header-inner">
                                <div className="brand header-brand">
                                    <h1 className="m-0">
                                        <a href="https://github.com/josepfpinto">
                    ...
                    <main>
                        ...
                        <div className="hero-copy">
                                    ...
                                    <p className="hero-paragraph">An unique landing page template works on all devices, so you only have to set it up once, and get beautiful results forever.</p>
                                    <div className="hero-cta"><a className="button button-shadow" href="https://github.com/josepfpinto">Learn more</a><a className="button button-primary button-shadow" href="https://github.com/josepfpinto">Early access</a></div>
                        </div>
                        ...
                        <img className="device-mockup" src={dummyImage} alt="App preview" />
                                ...
                                <div className="newsletter-inner section-inner">
                                    ...
                                    <div className="footer-form newsletter-form field field-grouped">
                                        ...
                                        <div className="control">
                                            <a className="button button-primary button-block button-shadow" href="https://github.com/josepfpinto">Early access</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path d="M13.666 31.889c7.547 0 10.924-7.307 10.924-14.854 0-7.547-3.377-7.027-10.924-7.027C6.118 10.008 0 13.055 0 20.603c0 7.547 6.118 11.286 13.666 11.286z" fill="url(#logo-footer-b)" transform="matrix(-1 0 0 1 24.59 0)"/>
                                ...
                                <ul className="footer-links list-reset">
                                    <li>
                                        <a href="https://github.com/josepfpinto">Contact</a>
                                    </li>
                                    <li>
                                        <a href="https://github.com/josepfpinto">About us</a>
                                    </li>
                                    <li>
                                        <a href="https://github.com/josepfpinto">FAQ's</a>
                                    </li>
                                    <li>
                                        <a href="https://github.com/josepfpinto">Support</a>
                                    </li>
                                </ul>
